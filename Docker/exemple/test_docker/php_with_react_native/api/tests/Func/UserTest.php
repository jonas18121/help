...
class UserTest extends AbstractEndPoint
{
     ...
     * 
     * Test : Modifier un user sans avoir de token
     * 
     * testPutUsers dépend de testGetOneUsers
     * 
     * 3 assertions
     * 
     * - Vérifier si le statusCode est bien en 401
     * 
     * - Vérifier si le contenu de $responseContent est bien en json
     * 
     * - Vérifier si le contenu de $responseDecoded n'est pas vide 
     ...
     * @return void
     */
    public function testPutUsers(int $id) : void
    {
        $response = $this->getResponseFromRequest(
            Request::METHOD_PUT, 
            '/api/users/' . $id, 
     ...
     * @depends testGetOneUsers
     * 
     * Test : Supprimer un user sans avoir de token
     * 
     * testDeleteUsers dépend de testGetOneUsers
     * 
     * 3 assertions
     * 
     * - Vérifier si le statusCode est bien en 401
