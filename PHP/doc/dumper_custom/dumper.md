# Différent type de dumper custom
 ...
 * @param bool $isDie - sur false par défault , permet d'activer ou pas, la function die() 
 * @param mixed $param2 - (facultative) Tous les types de param sont accepter 
 * 
 * @return void - retourne la valeur de var_dump 
 */ 
function pre_var_dump($param1, bool $isDie = false, $param2 = null) : void 
{ 
    echo '<pre style="color:black;background-color: lightgrey">'; 
        $param2 === null ? var_dump($param1) : var_dump($param1, $param2); 
        if ($isDie === true) die; 
    echo '</pre>'; 
}
