...
# FormType avec contrainte et fait partie d'un groupe de validation
        ...
        $builder
            ->add('gender', ChoiceType::class, [
                ...
                'constraints' => new NotBlank([
                    'message' => 'Choisissez votre civilité.',
                    'groups' => 'registration'
                ]),
            ])
            ->add('lastname', TextType::class, [
            ...
            ->add('recommendedLetter', CheckboxType::class, [
                ...
                'constraints' => new IsTrue([
                    'message' => 'Cochez la case pour avaoir une lettre recommander',
                    'groups' => 'registration',
                ]),
            ])
            ->add('postalcode', TextType::class, [
